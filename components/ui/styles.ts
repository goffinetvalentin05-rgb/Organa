...
/** Carte glass dark — landing premium */
export const landingGlassCardClass =
  "rounded-2xl border border-white/[0.08] bg-white/[0.04] shadow-[0_8px_32px_rgba(0,0,0,0.4),inset_0_1px_0_rgba(255,255,255,0.06)] backdrop-blur-xl transition duration-300 hover:border-[#3b82f6]/35 hover:shadow-[0_12px_40px_rgba(26,35,255,0.2)]";
