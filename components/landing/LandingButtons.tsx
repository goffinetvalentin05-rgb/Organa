...
export function LandingPrimaryButton({
  ...
  return (
    <motion.div whileHover={hoverLift} whileTap={tap} className="group relative inline-flex w-full sm:w-auto">
      {isLight ? (
        <span
      ...
      <Link
        ...
        className={
          isLight
            ? `landing-cta-primary relative inline-flex w-full items-center justify-center gap-2 overflow-hidden rounded-full border border-[rgba(37,99,235,0.14)] bg-white px-7 py-3.5 text-base font-bold text-[#1D4ED8] shadow-[0_10px_30px_rgba(37,99,235,0.10)] transition-[box-shadow,transform,background-color,border-color] duration-300 hover:border-[rgba(37,99,235,0.22)] hover:bg-[#EFF6FF] hover:shadow-[0_12px_36px_rgba(37,99,235,0.14)] md:px-8 md:py-4 ${className}`
            : `landing-cta-primary relative inline-flex w-full items-center justify-center gap-2 overflow-hidden rounded-full bg-white px-7 py-3.5 text-base font-bold text-[#1D4ED8] shadow-[0_0_32px_rgba(37,99,235,0.35),0_8px_28px_rgba(2,6,23,0.38),inset_0_1px_0_rgba(255,255,255,0.95)] transition-[box-shadow,transform] duration-300 hover:shadow-[0_0_48px_rgba(37,99,235,0.5),0_12px_36px_rgba(2,6,23,0.42)] md:px-8 md:py-4 ${className}`
        }
      >
        {!isLight ? (
          <>
