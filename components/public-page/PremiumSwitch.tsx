...
export default function PremiumSwitch({
  ...
  return (
    <button
      ...
      className={cn(
        "relative inline-flex h-11 w-14 shrink-0 items-center justify-center rounded-full touch-manipulation",
    ...
    >
      ...
      >
        <span
          className={cn(
            "absolute top-0.5 left-0.5 h-6 w-6 rounded-full bg-white shadow-sm transition-transform duration-200 ease-out",
