...
export default function DashboardShell({
  ...
  const navigationSecondary = [
    ...
    { name: t("dashboard.nav.supporters"), href: "/tableau-de-bord/supporters", icon: Heart },
    { name: t("dashboard.nav.supportSales"), href: "/tableau-de-bord/ventes-soutien", icon: Gift },
  ...
  // Pages MFA : plein écran sans sidebar (utilisées aussi par Associations via ?next=)
  if (
    pathname?.startsWith("/tableau-de-bord/securite/mfa/configurer") ||
    pathname?.startsWith("/tableau-de-bord/securite/mfa/verifier")
  ) {
    return (
      <div className="min-h-[100dvh] bg-gradient-to-b from-[#071634] via-[#102d78] to-[#175dd4]">
