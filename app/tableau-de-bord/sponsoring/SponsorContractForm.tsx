  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
      <SectionCard title={t("dashboard.sponsoring.detail.title")} icon={Handshake}>
        ...
        <fieldset className="mt-6 space-y-3 border-t border-white/30 pt-6">
          <legend className="text-sm font-semibold text-slate-800">{t("dashboard.sponsoring.form.endDate")}</legend>
      ...
      <SectionCard
        title={t("dashboard.sponsoring.form.content")}
        icon={FileText}
        headerRight={
          <button
            type="button"
            onClick={insertTemplate}
            className="rounded-lg border border-slate-200/60 bg-white/40 px-3 py-1.5 text-sm font-semibold text-slate-700 transition hover:border-slate-300/70 hover:bg-white/60"
          >
      ...
      >
        <textarea
          className="input-obillz min-h-[220px] w-full font-mono text-sm leading-relaxed"
