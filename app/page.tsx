export default function Home() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900/50 to-slate-950 text-white">
      {/* SECTION 1 — HERO */}
      <section className="relative min-h-screen flex flex-col items-center justify-center px-6 py-32 md:py-40">
      ...
      <section className="relative py-32 md:py-40 px-6 bg-gradient-to-b from-slate-950/95 via-slate-900/30 to-slate-950/95">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-20 text-left leading-[1.1] tracking-[-0.02em]">
            Le problème
          </h2>
          
          <div className="space-y-8">
            <div className="bg-black/20 border border-white/5 rounded-2xl p-10 md:p-12 backdrop-blur-sm shadow-lg shadow-black/20">
            ...
            <div className="bg-black/15 border border-white/5 rounded-2xl p-10 md:p-12 backdrop-blur-sm shadow-lg shadow-black/20">
            ...
            <div className="bg-gradient-to-br from-blue-950/30 via-purple-950/20 to-blue-950/30 border border-blue-500/10 rounded-2xl p-10 md:p-12 backdrop-blur-sm shadow-lg shadow-blue-950/20">
      ...
      <section className="relative py-32 md:py-40 px-6 bg-gradient-to-b from-slate-950/95 via-slate-900/30 to-slate-950/95">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-black/30 to-blue-950/20 border border-white/10 rounded-2xl p-12 md:p-16 backdrop-blur-sm mb-12 shadow-xl shadow-black/30">
      ...
      <section className="relative py-32 md:py-40 px-6 bg-gradient-to-b from-slate-950/95 via-slate-900/30 to-slate-950/95">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-10 text-left leading-[1.1] tracking-[-0.02em]">
            Comment ça marche
          </h2>
          
          <p className="text-xl md:text-2xl text-white/70 mb-20 leading-relaxed font-normal max-w-4xl">
            Un fonctionnement simple, pensé pour votre gestion quotidienne.
          </p>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Étape 1 */}
            <div className="bg-black/20 border border-white/10 rounded-2xl p-8 backdrop-blur-sm hover:border-white/20 hover:bg-black/30 transition-all duration-300 shadow-lg shadow-black/20">
              <div className="w-14 h-14 bg-gradient-to-br from-blue-500/20 to-purple-500/10 border border-blue-500/30 rounded-xl flex items-center justify-center mb-6">
      ...
      <section className="relative py-32 md:py-40 px-6 bg-gradient-to-b from-slate-950/95 via-slate-900/30 to-slate-950/95">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-black/20 border border-white/10 rounded-2xl p-8 backdrop-blur-sm hover:border-blue-500/30 hover:bg-black/30 transition-all duration-300 shadow-lg shadow-black/20">
            ...
            <div className="bg-black/20 border border-white/10 rounded-2xl p-8 backdrop-blur-sm hover:border-purple-500/30 hover:bg-black/30 transition-all duration-300 shadow-lg shadow-black/20">
      ...
      {/* SECTION 6 — TARIFS */}
      <section id="tarifs" className="relative py-32 md:py-40 px-6 bg-gradient-to-b from-slate-950/95 via-slate-900/30 to-slate-950/95">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-20 text-left leading-[1.1] tracking-[-0.02em]">
            Tarifs
          </h2>
          <div className="max-w-4xl">
            <div className="bg-black/20 border border-white/10 rounded-2xl p-10 md:p-12 backdrop-blur-sm shadow-lg shadow-black/20">
      ...
      {/* Footer */}
      <footer className="relative py-20 px-6 bg-black/30 border-t border-white/5">
        <div className="max-w-5xl mx-auto">
