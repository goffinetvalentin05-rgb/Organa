    ...
    <div className="min-h-screen bg-black relative overflow-hidden">
            ...
            >
              <Link href="/inscription">
                <motion.div
                  ...
                  whileHover={{ scale: 1.05, boxShadow: "0 25px 60px rgba(59, 130, 246, 0.6)" }}
                  whileTap={{ scale: 0.98 }}
                >
                  {/* Glow néon au hover */}
                  <motion.div 
                    className="absolute inset-0 bg-blue-400/30 blur-2xl opacity-0 group-hover:opacity-100"
      ...
      <section className="relative py-12 md:py-20 px-6">
        <div className="max-w-7xl mx-auto relative z-10">
          <ScrollReveal delay={0}>
            <motion.div 
              className="rounded-2xl bg-[#0f1419]/90 backdrop-blur-2xl border border-white/10 overflow-hidden shadow-2xl max-w-6xl mx-auto group/dashboard hover:border-blue-500/20 transition-all duration-500"
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {[
              ...
              <ScrollReveal key={index} delay={index * 80}>
                <motion.div 
                  className="p-6 rounded-2xl bg-white/[0.02] backdrop-blur-xl border border-white/5 hover:border-blue-500/40 hover:bg-white/[0.04] transition-all duration-500 group relative overflow-hidden h-full"
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-blue-500/5 opacity-0 group-hover:opacity-100 blur-xl transition-opacity duration-700"></div>
                  <div className="flex items-start gap-4 mb-4 relative z-10">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center text-white font-bold text-sm relative z-10 flex-shrink-0 shadow-lg shadow-blue-500/30 group-hover:shadow-blue-500/50 transition-shadow duration-500">
                      {index + 1}
                    </div>
                    <motion.div 
      ...
      <section id="tarifs" className="relative py-20 md:py-32 px-6">
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <ScrollReveal delay={0}>
              <motion.div 
                className="p-10 rounded-2xl bg-white/[0.02] backdrop-blur-xl border border-white/5 hover:border-blue-500/30 hover:bg-white/[0.04] transition-all duration-500 group relative overflow-hidden"
                whileHover={{ y: -5, scale: 1.02 }}
                transition={{ duration: 0.3, ease: "easeOut" }}
              >
                <div className="absolute inset-0 bg-gradient-to-br from-blue-500/8 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                ...
                <Link href="/inscription">
                  <motion.div
                    className="block w-full text-center px-6 py-3 rounded-xl bg-white/10 border border-white/20 text-white font-semibold hover:bg-white/20 hover:border-blue-500/40 transition-all duration-300 relative z-10 text-sm group/btn overflow-hidden"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.98 }}
                  >
                    <motion.div 
                      className="absolute inset-0 bg-blue-500/10 opacity-0 group-hover/btn:opacity-100 transition-opacity duration-300"
                    ></motion.div>
                    <span className="relative z-10">Commencer</span>
                  </motion.div>
                </Link>
            ...
            <ScrollReveal delay={150}>
              ...
              >
                ...
                <Link href="/inscription">
                  <motion.div
                    className="block w-full text-center px-6 py-3 rounded-xl bg-white text-black font-semibold hover:bg-white/95 transition-all duration-300 shadow-xl hover:shadow-2xl hover:shadow-blue-500/30 relative z-10 text-sm group/btn overflow-hidden"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.98 }}
                  >
                    <motion.div 
                      className="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-cyan-500/10 opacity-0 group-hover/btn:opacity-100 transition-opacity duration-300"
                    ></motion.div>
