...
export default function Home() {
  return (
    <main className="w-full bg-gradient-to-b from-slate-950 via-slate-900/50 to-slate-950 text-white overflow-x-hidden">
      {/* SECTION 1 — HERO */}
      <section className="relative min-h-screen flex flex-col items-center justify-center px-6 py-32 md:py-40 mb-0">
        <div className="max-w-6xl mx-auto text-center">
          <h1 className="text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold mb-10 leading-[1.05] tracking-[-0.02em] text-white">
            Moins d'administratif.
            <br />
            Plus de temps pour ce qui compte vraiment.
          </h1>

          <p className="mt-16 mb-20 max-w-4xl mx-auto text-xl md:text-2xl text-white/70 leading-relaxed font-normal">
          ...
          <a
            href="/inscription"
            className="inline-flex items-center gap-2 rounded-xl bg-blue-500 hover:bg-blue-600 px-10 py-4 text-white font-medium text-lg transition-all duration-200 shadow-lg shadow-blue-500/20 hover:shadow-xl hover:shadow-blue-500/30"
          >
            Découvrir Organa
      ...
      <section className="relative py-24 md:py-32 px-6 bg-gradient-to-b from-slate-950/95 via-slate-900/30 to-slate-950/95 mt-0">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-16 md:mb-20 text-left leading-[1.1] tracking-[-0.02em]">
            Le problème
          </h2>
          
          <div className="space-y-6 md:space-y-8">
            <div className="bg-black/30 border border-white/10 rounded-3xl p-10 md:p-12 backdrop-blur-sm shadow-xl shadow-black/40">
              <p className="text-xl md:text-2xl text-white leading-relaxed font-normal">
            ...
            <div className="bg-black/20 border border-white/10 rounded-3xl p-10 md:p-12 backdrop-blur-sm shadow-lg shadow-black/30">
            ...
            <div className="bg-gradient-to-br from-blue-950/40 via-purple-950/30 to-blue-950/40 border border-blue-500/20 rounded-3xl p-10 md:p-12 backdrop-blur-sm shadow-xl shadow-blue-950/30">
      ...
      <section className="relative py-24 md:py-32 px-6 bg-gradient-to-b from-slate-950/95 via-slate-900/30 to-slate-950/95 mt-0">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-black/40 to-blue-950/30 border border-white/20 rounded-3xl p-12 md:p-16 backdrop-blur-sm mb-10 md:mb-12 shadow-2xl shadow-black/50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            <div className="bg-black/30 border border-white/10 rounded-3xl p-10 md:p-12 backdrop-blur-sm shadow-xl shadow-black/40 hover:border-white/20 transition-all duration-300">
              <p className="text-lg md:text-xl text-white/80 leading-relaxed">
      ...
      <section className="relative py-24 md:py-32 px-6 bg-gradient-to-b from-slate-950/95 via-slate-900/30 to-slate-950/95 mt-0">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 md:mb-10 text-left leading-[1.1] tracking-[-0.02em]">
            Comment ça marche
          </h2>
          
          <p className="text-xl md:text-2xl text-white/70 mb-16 md:mb-20 leading-relaxed font-normal max-w-4xl">
            Un fonctionnement simple, pensé pour votre gestion quotidienne.
          </p>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {/* Étape 1 */}
            <div className="bg-black/30 border border-white/10 rounded-3xl p-8 md:p-10 backdrop-blur-sm hover:border-blue-500/30 hover:bg-black/40 transition-all duration-300 shadow-xl shadow-black/40">
              <div className="w-16 h-16 bg-gradient-to-br from-blue-500/30 to-purple-500/20 border border-blue-500/40 rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-blue-500/20">
      ...
      <section className="relative py-24 md:py-32 px-6 bg-gradient-to-b from-slate-950/95 via-slate-900/30 to-slate-950/95 mt-0">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="bg-black/30 border border-white/10 rounded-3xl p-8 md:p-10 backdrop-blur-sm hover:border-blue-500/30 hover:bg-black/40 transition-all duration-300 shadow-xl shadow-black/40">
              <div className="w-16 h-16 mb-6 bg-gradient-to-br from-blue-500/30 to-blue-600/20 border border-blue-500/40 rounded-2xl flex items-center justify-center shadow-lg shadow-blue-500/20">
            ...
            <div className="bg-black/30 border border-white/10 rounded-3xl p-8 md:p-10 backdrop-blur-sm hover:border-purple-500/30 hover:bg-black/40 transition-all duration-300 shadow-xl shadow-black/40">
              <div className="w-16 h-16 mb-6 bg-gradient-to-br from-purple-500/30 to-purple-600/20 border border-purple-500/40 rounded-2xl flex items-center justify-center shadow-lg shadow-purple-500/20">
      ...
      {/* Footer */}
      <footer className="relative py-16 md:py-20 px-6 bg-black/40 border-t border-white/10">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-6">
              <a href="/connexion" className="text-white/50 hover:text-white/80 text-sm transition-colors">
                Connexion
              </a>
              <a href="/inscription" className="text-white/50 hover:text-white/80 text-sm transition-colors">
                Inscription
              </a>
            </div>
          </div>
